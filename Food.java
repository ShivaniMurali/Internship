...
public class Food{
 ...
 class Food1 implements Serializable
{
    int itemno;
    int quantity;   
    float price;
    
    Food1(int itemno,int quantity)
    {
        this.itemno=itemno;
        ...
        switch(itemno)
        {
            case 1:price=quantity*45;
                break;
            case 2:price=quantity*55;
                break;
            case 3:price=quantity*65;
                break;
...
class Singleroom implements Serializable
{
    ...
    String contact;
    String gender;   
    ArrayList<Food1> food =new ArrayList<>();
...
class Hotel
{
    ...
    {
        String name, contact, gender,aadharnumber;
        String name2 = null, contact2 = null,aadharnumber2; 
        String gender2="";
        System.out.print("\nEnter customer name: ");
        name = sc.next();
        ...
        System.out.print("Enter gender: ");
        gender2 = sc.next();
        System.out.print("Enter aadhar Number2: ");
        aadharnumber2 = sc.next();
        }      
        ...
        switch(rtype)
        {
            case 1:
                amount+=4000;
                    ...
                    System.out.println("-------------------------");
                    for(Food1 obb:hotel_ob.luxury_doublerrom[rn].food)
                    {
                        amount+=obb.price;
            ...
            case 2:amount+=3000;
                    ...
                    System.out.println("===============");
                     System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food1 obb:hotel_ob.deluxe_doublerrom[rn].food)
                    {
                        amount+=obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
            ...
            case 3:amount+=2200;
                    ...
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food1 obb:hotel_ob.luxury_singleerrom[rn].food)
                    {
                        amount+=obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
            ...
            case 4:amount+=1200;
                    ...
                    System.out.println("Item   Quantity    Price");
                    System.out.println("-------------------------");
                    for(Food1 obb: hotel_ob.deluxe_singleerrom[rn].food)
                    {
                        amount+=obb.price;
                        String format = "%-10s%-10s%-10s%n";
                        System.out.printf(format,list[obb.itemno-1],obb.quantity,obb.price );
    ...
    static void order(int rn,int rtype)
    {
        ...
        do
        {
            ...
            q=sc.nextInt();
              ...
              switch(rtype){
            case 1: hotel_ob.luxury_doublerrom[rn].food.add(new Food1(i,q));
                break;
            case 2: hotel_ob.deluxe_doublerrom[rn].food.add(new Food1(i,q));
                break;
            case 3: hotel_ob.luxury_singleerrom[rn].food.add(new Food1(i,q));
                break;
            case 4: hotel_ob.deluxe_singleerrom[rn].food.add(new Food1(i,q));
                break;                                                 
        }
